...
# from tensorboard import Summar
...
def main():
    ...
    Train(train_loader, net, criterion, optimizer, args)
...
def train(train_loader, net, criterion, optimizer, epoch, train_args):
    ...
    for i, data in enumerate(train_loader):
        ...
        assert outputs.size()[1] == 2  # num classes
...
def Train(train_loader, net, criterion, optimizer, train_args):
